package part_2_object_programming.GeometricFigures;
...
public class ShapeCalculatorTest {
    public static void main(String[] args) {
        ...
        System.out.println("Czy punkt leży w okręgu " + pointInsideCircleOk);
        System.out.println("Czy punkt leży w okręgu " + pointInsideCircleNotOk);
    }
}
